...
Tais parâmetros foram construídos a partir da pesquisa saúde bucal (SB 2010). Com base na prevalência de determinadas condições de saúde bucal, foi calculada a necessidade de cobertura para cada faixa-etária. A lógica usada foi a seguinte:
...
Considerando os dados de população e de cobertura, temos os seguintes resultados:
