...
## 5. Levantando a faixa etária (P) - Brasil
...
pop_brasil_tratado <- pop_brasil |>
                  select(cod_municipiodv, municipio, de_0_a_14_anos,
                         de_15_a_29_anos, de_30_a_59_anos,
                         acima_de_60_anos) |> 
                  gather(key = "faixa", 
                         value = "total",
                         3:6) |> 
                  mutate(faixa = gsub("_"," ",faixa)) |> 
                  mutate(ibge = as.character(cod_municipiodv)) |> 
...
## 6. Prevalência de condições de saúde bucal (H) - Brasil
