...
Vamos gerar a visualização usando um mapa cloroplético por região de saúde. Para isso, precisamos, primeiramente fazer um tratamento para agregar os resultados por regiões de saúde.
